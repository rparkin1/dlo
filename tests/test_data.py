"""Test suite for the `dlo.data` module."""
...
from dlo import data


class TestEncodeDecode(unittest.TestCase):
    """Test case for the `dlo.data.encode` and `dlo.data.decode` functions."""
    ...
    def test_encode_decode(self):
        """Base test for the `dlo.data.encode/.decode` functions."""
    ...
    def test_encode_decode_numpy(self):
        """Base test for the `dlo.data.encode` function."""
...
class TestParse(unittest.TestCase):
    """Test case for the `dlo.data.decode` function."""

    def test_parse(self):
        """Base test for the `dlo.data.decode` function."""
