"""Data management for the `dlo` package.

A `dlo` example is made of essentially two sequences of symbols:
...
def encode(words_idxs, formula_idxs):
    ...
    Returns:
      a `tf.train.Example` to be consumed by the dlo architecture.
