"""Model implementation for the `dlo` system."""
...
class ModelInputs(configurable.Configurable):
    """dlo model input tensors parser."""
...
class Model(configurable.Configurable):
    ...
    def get_default_params(cls):
        return OrderedDict([
            ...
            (cls.INPUT_CLASS_PK, 'dlo.model.ModelInputs'),
            (cls.INPUT_PARAMS_PK, ModelInputs.get_default_params()),
            (cls.LOSS_NAME_PK, 'dlo.train.XEntropy'),
            (cls.OPTIMIZER_CLASS_PK, 'dlo.train.SGD'),
